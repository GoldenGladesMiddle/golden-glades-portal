...
export default function AdminApplicationPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    confidenceRating: '',
    whyApply: '',
    disruptiveStudentScenario: '',
    strongCandidate: '',
    estimatedEmployment: '',
    difficultDecisionScenario: '',
    device: '',
    resultsMethod: '',
    resultsOtherDetails: '',
  });
          ...
          <div className="bg-white p-8 md:p-10 rounded-2xl border border-slate-200 shadow-sm space-y-8">
            {submitted ? (
              <div className="text-center py-12 space-y-4">
                ...
                <h2 className="text-2xl font-bold text-slate-800">Administrator Application Submitted!</h2>
                <p className="text-slate-600 text-sm max-w-md mx-auto">
                  Thank you for applying for a leadership position at Golden Glades Middle School. Your application has been logged and will be reviewed by human resources shortly.
                </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        <input 
                          type="checkbox" 
                          id="reqAvailability" 
                          name="reqAvailability" 
                          checked={formData.reqAvailability}
                          onChange={handleChange}
                          required 
                          className="text-[#284b85] focus:ring-[#284b85] rounded" 
                        />
                        <label htmlFor="reqAvailability" className="text-sm text-slate-700">I understand.</label>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea 
                        rows={3} 
                        name="disruptiveStudentScenario"
                        value={formData.disruptiveStudentScenario}
                        onChange={handleChange}
                        required 
                        placeholder="Your answer" 
                        className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-[#284b85] text-sm" 
                    ...
                    <div>
                      ...
                      <textarea 
                        rows={3} 
                        name="strongCandidate"
                        value={formData.strongCandidate}
                        onChange={handleChange}
                        required 
                        placeholder="Your answer" 
                        className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-[#284b85] text-sm" 
                    ...
                    <div>
                      ...
                      <textarea 
                        rows={3} 
                        name="difficultDecisionScenario"
                        value={formData.difficultDecisionScenario}
                        onChange={handleChange}
                        required 
                        placeholder="Your answer" 
                        className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-[#284b85] text-sm" 
                  ...
                  >
                    {isSubmitting ? 'Submitting Application...' : 'Submit Administrator Application'}
                  </button>
                </form>
              </>
            )}
