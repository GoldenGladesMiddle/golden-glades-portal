      ...
      <div>
        ...
        <section className="bg-gradient-to-r from-[#284b85] to-[#1a3861] text-white py-12 px-4 md:px-8 border-b-4 border-amber-400">
          <div className="max-w-4xl mx-auto text-center space-y-2">
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight">GGMS | General Staff Application</h1>
            <p className="text-amber-300 text-sm md:text-base">Golden Glades Middle School Operations</p>
          </div>
        </section>
          ...
          <div className="bg-white p-8 md:p-10 rounded-2xl border border-slate-200 shadow-sm space-y-8">
            {submitted ? (
              <div className="text-center py-12 space-y-4">
                ...
                <h2 className="text-2xl font-bold text-slate-800">Staff Application Submitted!</h2>
                <p className="text-slate-600 text-sm max-w-md mx-auto">Thank you for applying. Your application will be reviewed shortly.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input type="text" name="rpName" value={formData.rpName} onChange={handleChange} required placeholder="Example: Mr. D. Smith" className="w-full px-4 py-2.5 rounded-lg border border-slate-300 text-sm" />
                </div>
                ...
                <div>
                  <label className="block text-sm font-semibold text-slate-800 mb-2">5. Desired Staff Position <span className="text-red-500">*</span></label>
                  <select name="desiredRole" value={formData.desiredRole} onChange={handleChange} required className="w-full px-4 py-2.5 rounded-lg border border-slate-300 text-sm bg-white">
                    <option value="">Choose Position</option>
                    <option value="Teacher">Teacher</option>
                    <option value="Hall Monitor">Hall Monitor</option>
                    <option value="Security">Security</option>
                  </select>
                </div>

                <div>
                  <label className="block text-sm font-semibold text-slate-800 mb-1">6. Why do you want to join GGMS staff? <span className="text-red-500">*</span></label>
