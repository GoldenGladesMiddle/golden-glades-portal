      ...
      <div>
        ...
        <section className="bg-gradient-to-r from-[#284b85] to-[#1a3861] text-white py-12 px-4 md:px-8 border-b-4 border-amber-400">
          <div className="max-w-4xl mx-auto text-center space-y-2">
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight">Staff Application</h1>
            <p className="text-amber-300 text-sm md:text-base">Golden Glades Middle School Careers</p>
          </div>
        </section>
        ...
        <main className="max-w-3xl mx-auto px-4 md:px-8 py-12 flex-grow w-full">
          <div className="bg-white p-8 md:p-10 rounded-2xl border border-slate-200 shadow-sm space-y-6">
            <form className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-800 mb-1">Position Desired</label>
                <select required className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-[#284b85] text-sm bg-white">
                  ...
                  <option value="elective_teacher">Elective Teacher</option>
                  <option value="substitute_teacher">Substitute Teacher</option>
                  <option value="teaching_aide">Teaching Aide</option>
                  <option value="school_security">School Security</option>
                  <option value="office_secretary">Office Secretary</option>
                  <option value="nurse">Nurse</option>
                </select>
              </div>

              <div>
                <label className="block text-sm font-semibold text-slate-800 mb-1">Why do you want to join Golden Glades Middle?</label>
                <textarea rows={4} required placeholder="Explain your motivation and goals..." className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-[#284b85] text-sm" />
              </div>

              <div>
                <label className="block text-sm font-semibold text-slate-800 mb-1">Relevant Experience</label>
                <textarea rows={4} required placeholder="List any previous school or leadership experience..." className="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-[#284b85] text-sm" />
              </div>
